        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 flex items-center gap-2 sm:gap-3">
            ...
            <p className="text-xs sm:text-sm text-amber-800 font-medium">
              <span className="hidden sm:inline">Sandbox mode - no real money moves. All transactions are simulated.</span>
              <span className="sm:hidden">Sandbox mode - simulated only</span>
            </p>
          </div>
