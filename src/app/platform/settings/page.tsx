          ...
          <div className="max-w-4xl space-y-6">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-amber-900 mb-1">Platform-Wide Configuration</p>
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Effective since Feb 1, 2024</p>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Fee charged on money collection</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">Fee charged on disbursements</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-baseline gap-2">
                      <span className="text-xl font-bold text-muted-foreground">GHS</span>
                      <input
                        type="number"
                        value={minimumFee}
                        onChange={(e) => {
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <h3 className="text-sm font-semibold mb-3" style={{ fontFamily: "var(--font-heading)" }}>Fee Examples</h3>
                <div className="grid grid-cols-3 gap-4">
                  {[100, 1000, 10000].map((amount) => {
                    ...
                    return (
                      <div key={amount} className="p-4 bg-muted/30 rounded-xl">
                        <p className="text-xs text-muted-foreground mb-2">GHS {amount.toLocaleString()} transaction</p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <label className="block text-sm font-semibold">Maximum Single Transaction</label>
                      <p className="text-xs text-muted-foreground mt-0.5">Per-transaction limit for all channels</p>
                    </div>
                    {canEdit && <Edit className="size-4 text-muted-foreground" />}
                  </div>
                  <div className="flex items-center gap-3">
                    <span className="text-lg font-semibold text-muted-foreground">GHS</span>
                    <input
                      type="number"
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <label className="block text-sm font-semibold">Daily Transaction Limit</label>
                      <p className="text-xs text-muted-foreground mt-0.5">Cumulative daily limit per merchant</p>
                    </div>
                    {canEdit && <Edit className="size-4 text-muted-foreground" />}
                  </div>
                  <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      <label className="block text-sm font-semibold">Monthly Transaction Limit</label>
                      <p className="text-xs text-muted-foreground mt-0.5">Cumulative monthly limit per merchant</p>
                    </div>
                    {canEdit && <Edit className="size-4 text-muted-foreground" />}
                  </div>
                  <div className="flex items-center gap-3">
                ...
                {[
                  ...
                  <div key={schedule.day} className="flex items-center justify-between p-4 bg-muted/30 rounded-xl">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-semibold text-sm">{schedule.day} Settlement</p>
                        <p className="text-xs text-muted-foreground">Runs at {schedule.time} GMT</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <p className="text-xs text-muted-foreground">Next run</p>
                        <p className="text-sm font-semibold">{schedule.nextRun}</p>
                      </div>
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={user.email} className="flex items-center justify-between p-4 border border-border rounded-xl hover:bg-muted/20 transition-colors">
                    ...
                    <div className="flex items-center gap-4">
                      <span className="px-3 py-1 bg-muted rounded-lg text-xs font-medium">{user.role}</span>
                      <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-full border font-medium bg-emerald-50 text-emerald-700 border-emerald-200">
          ...
          <div className="max-w-4xl space-y-4">
            ...
            <div className="bg-card border border-border rounded-2xl p-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <h3 className="text-sm font-semibold mb-3" style={{ fontFamily: "var(--font-heading)" }}>Platform Details</h3>
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-2 py-0.5 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded text-xs font-semibold">Production</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Region</span>
                      <span className="font-semibold">West Africa (Ghana)</span>
                    </div>
                    <div className="flex items-center justify-between">
                ...
                <div>
                  <h3 className="text-sm font-semibold mb-3" style={{ fontFamily: "var(--font-heading)" }}>Last Updated</h3>
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center justify-between">
