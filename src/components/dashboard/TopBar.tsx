...
export default function TopBar({ onMenuToggle }: TopBarProps) {
  ...
  return (
    <header className="flex items-center justify-between h-14 px-4 lg:px-5 bg-white/95 backdrop-blur-xl border-b border-gray-200/50 sticky top-0 z-30 shrink-0">
      ...
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        >
          <div
            className={cn(
              "flex items-center gap-2 w-full h-8 px-3 rounded-xl border transition-all duration-200 cursor-text",
              searchFocus
