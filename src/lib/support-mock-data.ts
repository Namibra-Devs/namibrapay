...
export const mockSupportTickets: SupportTicket[] = [
  {
    ...
    description: "Since 2pm today, all MTN MoMo collection requests are timing out after 30 seconds. Vodafone and AirtelTigo are working fine. Affecting approximately 20 transactions so far. Customers are calling to complain.",
  ...
  tkt1: [
    {
      ...
      author: "Kwame Asante",
      authorType: "merchant",
      message: "Since 2pm today, all MTN MoMo collection requests are timing out after 30 seconds. Vodafone and AirtelTigo are working fine. Affecting approximately 20 transactions so far. Customers are calling to complain.",
...
export const mockSlaMetrics: SlaMetric[] = [
  ...
  {
    providerId: "p4",
    providerName: "GhIPSS / GIP",
    openIssues: { critical: 2, major: 3, minor: 4 },
    avgResponseTime: 4.2,
...
export const mockSecurityIncidents: SecurityIncident[] = [
  ...
  },
  {
    ...
    impactAssessment: "GHS 890 in test transactions. 8 merchant accounts involved. MTN and Vodafone notified within 4 hours.",
    mitigationSteps: [
      "All 8 merchant accounts suspended pending investigation",
      "Transaction velocity rules tightened",
      "MTN and Vodafone fraud teams notified",
